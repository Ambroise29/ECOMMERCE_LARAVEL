                    ...
                    <tbody>
                       ...
                       <tr>
                        <td>{{ $item->id }}</td>
                          ...
                          <td><img src="{{ asset('images/produits/'.$item->image) }}" width="100px" height="100px"></td>
                          <td> <a href="{{ url('edite-produit/'.$item->id) }}"><span class="badge bg-warning text-dark">editer</span></a></td>
